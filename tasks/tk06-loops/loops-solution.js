/*
 * TASK :
 * 1. Iterate all the elements of the given array countries
...
for (var i = 0; i < countries.length; i++) {
    console.log(countries[i].country + " has an area of " + countries[i].area + " km2");
    betterPrintDensity(countries[i]);
}
